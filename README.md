...
**On the Map** is simple application that lets Udacity students log in either with email and password or through Facebook and then they can access pins that other students have placed on a map at their location. The pins point to an interesting resource that the student wants to share with other students.

It showcases how to use **web APIs** and **authentication**, how to **geocode a location** based on a description and display that information on a map or a table view. Being able to access information through a web API and present it either in a table view or other method (here a map) is a basic skill. This can help others learn this.


#### Documentation

The code is well documented. More information can be found on the [project's page](http://hexaedre.com/projects/on-the-map/).
...
More information and screenshots can be found on the [project's page](http://hexaedre.com/projects/on-the-map/). If you have questions I'd be happy to help. Contact information can be found below or on the project's page.
